  ...
  return (
    <div className="proposalForm_cont">
      <div className="ProposalForm">
        ...
        <Link to={'/proposal'}>
          <CloseIcon className="proposalForm_icon">
        ...
        <form onSubmit={formSubmitHandler}>
            ...
            <div className="proposalForm_right">
              <div className="form_individual">
                <div className="proposalForm_image_head">
                  ...
                  />
                  <button className="Imagebtn" disabled={loading} onClick={submitHandler}>
                    {loading ? "Loading..." : "Add"}
                  </button>
                </div>
          ...
          <div className="buttonDiv">
            <button type="submit" className="postButton" onClick={formSubmitHandler}>
              POST
            </button>
          </div>
        </form>
